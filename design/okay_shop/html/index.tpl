    ...
    <div class="container">
        ...
        <div class="times">
            <div class="times_inner">
                ...
                <!--div><span data-language="company_open_hours">{*$lang->dateNow} {$lang->string*}</span></div-->
            </div>
        </div>
            ...
            <div class="row">
                <div class="foot col-sm-6 col-lg-4">
                    ...
                    <div class="foot_social">
                        ...
                        <a class="vk" href="https://vk.com/club72497645" target="_blank" title="� ��������"></a>
                        <a class="ok" href="{preg_replace('/^(.+)\/$/', '$1', $lang_link)}#" target="_blank" title="�������������"></a>
